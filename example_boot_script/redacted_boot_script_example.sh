###! Contained is a redacted sample version of this project's Linux VPS boot script used to create the Docker hosted NGINX reverse proxy server and Wireguard VPN
...
# Public key for the new sudo user
